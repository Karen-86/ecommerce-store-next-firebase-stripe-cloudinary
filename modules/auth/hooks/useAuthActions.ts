...
export const useAuthActions = () => {
  ...
  const handleSignIn = async ({ email = "", password = "", setIsLoading = (_: boolean) => {} }) => {
    ...
    try {
      ...
      if (!res.user.emailVerified) alert("This email isn’t verified. Check your inbox to verify.")
    } catch (err: any) {
  ...
  const handleSignInWithGoogle = async ({ setIsLoading = (_: boolean) => {} } = {}) => {
    ...
    try {
      ...
      alert("Sign in successfull!", 'Successfully signed in with Google')
      if (!res.user.emailVerified) alert("This email isn’t verified. Check your inbox to verify.")
    } catch (err: any) {
  ...
  const handleSignOut = async ({ successCB = noop, setIsLoading = (_: boolean) => {} } = {}) => {
    ...
    try {
      ...
      details.push({ status: "success", message: "Sign out successfull!" })
  ...
  const handleEmailVerification = async ({
    ...
    try {
      ...
      if (!ignoreAlert) alert("Verification email sent! Please check your inbox.")
    } catch (err: any) {
      errorAlert(err.message || "Internal server error. Please try again later.")
  ...
  const handleLinkEmailPasswordAccount = async ({
    ...
    try {
      ...
      // alert("Successfully linked email/password account!")
      successCB()
    } catch (err: any) {
      errorAlert(err.message || "Internal server error. Please try again later.")
  ...
  const handleUpdateEmail = async ({ email = "", setIsLoading = (_: boolean) => {}, successCB = () => {} }) => {
    ...
    try {
      ...
      successCB()
      alert("Confirmation sent. Click the link in your new email to update.")
    } catch (err: any) {
      errorAlert(err.message || "Internal server error. Please try again later.")
